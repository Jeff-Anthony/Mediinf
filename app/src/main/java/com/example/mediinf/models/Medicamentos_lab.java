...
public class Medicamentos_lab {
    ...
    public Medicamentos_lab(){



    }

    public Medicamentos_lab(int codigo, String trata_enfermedad, String tipo, String nombre, String imagen, String informacion, String precio) {
        this.codigo = codigo;
