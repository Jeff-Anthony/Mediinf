...
import com.example.mediinf.activity.InfoGenericoActivity;
...
public class MedicamentosAdapter_gen extends RecyclerView.Adapter<MedicamentosAdapter_gen.ViewHolder>{
    ...
    public MedicamentosAdapter_gen() {
        this.medicamentos = new ArrayList<>();
    }

    public void setMedicamentos_gen(List<Medicamentos_gen> medicamentos){
        this.medicamentos = medicamentos;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.medi_detalle.setText(medicamentosGen.getDetalle());
        viewHolder.medi_precio.setText(medicamentosGen.getPrecio());

        String url = ApiService.API_BASE_URL + "/api/medicamentos_gen/images/" + medicamentosGen.getImagen();
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, InfoGenericoActivity.class);
                intent.putExtra("ID", medicamentosGen.getId());
